...
fid1 = fopen("./results/train_data/train_data_n1.txt","wt");
fid2 = fopen("./results/train_data/train_data_n2.txt","wt");
fid3 = fopen("./results/train_data/train_data_n3.txt","wt");
